...
public class ChatRightVideoHolder extends ChatRightHolder {

    private ImageView mRightImageContent;

    public ChatRightVideoHolder(View view, Activity activity, int activityType, WatchData watch, OnItemClickListener listener) {
    ...
    private void showVideo() {
        Bitmap bitmap = BitmapFactory.decodeFile(chat.getmAudioPath() + ChatRecyclerViewAdaper.VIDEO_PREVIEW_SUFFIX);
        if (bitmap != null) {
    ...
    private void showVideoSendState() {
