package com.xiaoxun.xun.motion.utils;
    ...
    public static ArrayList<SportRecordBean> onSportRecordToAdapterItemData(Context context, List<MotionSportRecordBeans> mList
        ...
        for (int i = 0; i < mList.size(); i++) {
            ...
            if(i == mList.size() - 1){
                ...
                mSportItemBean.setmSubDurTime((int)TimeUtil.compareToDiffForTwoTime(mMotionBean.getStime(), mMotionBean.getEtime())*1000);
            ...
            mSubTime += (int)TimeUtil.compareToDiffForTwoTime(mMotionBean.getStime(), mMotionBean.getEtime());
        }
