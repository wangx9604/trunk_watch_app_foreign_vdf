...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildAuthTokenMap(String app_id ,String sign,String auth_code ) {
		...
		keyValues.put("timestamp", strBeginDate);
		//调用的接口版本，固定为：1.0
		keyValues.put("version", "1.0");
		////值为authorization_code时，代表用code换取；值为refresh_token时，代表用refresh_token换取
		keyValues.put("grant_type", "authorization_code");
		keyValues.put("code", auth_code);
		return keyValues;
	}

	public static Map<String, String> buildAuthInfoMap(String app_id ,String sign,String auth_token ) {
		//https://openapi.alipay.com/gateway.do?
		Map<String, String> keyValues = new HashMap<String, String>();
		//支付宝分配给开发者的应用ID
		keyValues.put("app_id", app_id);
