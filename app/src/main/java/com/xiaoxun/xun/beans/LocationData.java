...
public class LocationData {
    ...
    public static LocationData parseLocation(Context context, JSONObject pl, LocationData location) {
        ...
        LogUtil.d("LocationData region = "+region+"  latitude = "+latitude +" longitude = "+ longitude);
        LogUtil.d("LocationData getMapType = "+location.getMapType());
        if (region == 460 || region == 461 || region == 454 || region == 455) {  //大陆
            switch (location.getMapType()) {
                case "0":
                case "2":
...
//        LogUtil.e("百度转换BDToGCJ02"+ GPSUtil.double_to_latLng(GPSUtil.bd09_To_Gcj02(Double.valueOf(31.170793),Double.valueOf(121.414732))));
//        LogUtil.e("百度转换BDToWGS"+ GPSUtil.double_to_latLng(GPSUtil.bd09_To_gps84(Double.valueOf(24.572465),Double.valueOf(120.827979))));
