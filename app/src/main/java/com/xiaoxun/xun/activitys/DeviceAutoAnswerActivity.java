...
public class DeviceAutoAnswerActivity extends NormalActivity implements MsgCallback {
    ...
    private void initData() {
        ...
        } else if (getMyApp().getCurUser().getFocusWatch().isDevice707_H01() || getMyApp().getCurUser().getFocusWatch().isDevice709_H01()) {
            modeMap.put(2, new String[]{getString(R.string.auto_answer_after_new), getString(R.string.auto_answer_after_new)});
        } else {
