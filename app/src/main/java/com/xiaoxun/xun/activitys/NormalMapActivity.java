...
public class NormalMapActivity extends FragmentActivity {
    ImibabyApp myApp;
...
//        }
    ...
    public void setTintColor(int colorValue){
        StatusBarUtil.changeStatusBarColor(this, colorValue);
    }
    ...
    private void processByBack(String adId,String adShowTime,String adTarUrl){
        new MioAsyncTask<String, Void, String>() {
            protected String doInBackground(String... params) {
                ...
                Intent _intent = new Intent(NormalMapActivity.this, SplashAdActivity.class);
