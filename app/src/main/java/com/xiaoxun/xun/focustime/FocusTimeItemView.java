...
public class FocusTimeItemView extends LinearLayout {
    ...
    //防打扰改版
    private FocusTimeBean focusTimeBean;

    public FocusTimeItemView(Context context){
        this(context, null);
        mContext = context;
    }
    public FocusTimeItemView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        ...
        view.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if(focusTimeBean.timeStampId.equals(Constants.SILENCE_TIME_MORNING_TIMEID)
                        || focusTimeBean.timeStampId.equals(Constants.SILENCE_TIME_AFTERNOON_TIMEID)){
                    return true;
                }
                if (mItemListen != null)
    ...
    public void setFocusTimeBean(FocusTimeBean bean){
        focusTimeBean = bean;
        updateViewBySetFocustTime();
    }
    public FocusTimeBean getFocusTimeBean(){
