...
//        }
    ...
    private void requestShareURL(){
        ...
        downLoader.HttpsDownloadList(XunKidsDomain.getInstance(this).getXunKidsFilesDomain(OVERSEAURL.FDSFILE_SHARE_URL),obj.toJSONString());
    }
    ...
    private void requestDownloadURL(){
        ...
        downLoader.HttpsDownloadList(XunKidsDomain.getInstance(getApplicationContext()).getXunKidsFilesDomain(OVERSEAURL.FDSFILE_DOWNLOAD_URL),obj.toJSONString());
    }
