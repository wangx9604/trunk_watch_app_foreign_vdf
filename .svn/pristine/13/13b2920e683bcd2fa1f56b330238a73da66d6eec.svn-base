package com.xiaoxun.xun.health.report.fragments.week;
...
public class WeekFragment extends Fragment {
    ...
    private HealthFatigueView chart_sight;
    private HealthFatigueView chart_brain;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new ViewModelProvider.NewInstanceFactory()).get(WeekFragmentViewModel.class);
    }
    ...
    private void setStepData(List<DayChartData> list){
        ...
        for(int i=0;i<list.size();i++){
            ...
            int d = getWeekDayFromTimeStamp(t);
            if(d != -1){
    ...
    private void setHeartData(List<KChartData> list){
        ...
        for(int i=0;i<list.size();i++){
            ...
            int d = getWeekDayFromTimeStamp(timeStamp);
            if(d != -1){
    ...
    private void clearCharts(){
        ...
        chart_heart.clear();
        chart_oxy.clear();
        chart_sight.clearChart();
        chart_brain.clearChart();
    }
