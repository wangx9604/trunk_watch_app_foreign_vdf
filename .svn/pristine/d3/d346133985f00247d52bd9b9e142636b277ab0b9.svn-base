...
public class ScheduleWeekSettingActivity extends NormalActivity {
    ...
    public void onCommitAction(){
        if(isInfoHasChange()){
            ...
            ArrayList<ScheduleWeekBean> mNewList1 = new ArrayList<>();
            for (ScheduleWeekBean scheduleWeekBean : mWeekArray) {
                    mNewList1.add(scheduleWeekBean);
            }
            Collections.sort(mNewList1);
            ...
            ArrayList<ScheduleWeekBean> mNewList2 = new ArrayList<>();
            for (ScheduleWeekBean scheduleWeekBean : mWeekArray) {
                mNewList2.add(scheduleWeekBean);
            }
            Collections.sort(mNewList2);
            if(ScheduleCardUtils.checkClassTimeConflict(
                    ScheduleWeekSettingActivity.this, mTimeArray)) return;
            ...
            LogUtil.e("updateScheduleCardInfo --isInfoHasChange-- mScheduleInfo = " + mScheduleInfo);
