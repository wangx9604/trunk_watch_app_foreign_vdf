...
import com.record.cameralibrary.state.CameraMachine;
import com.record.cameralibrary.util.FileUtil;
import com.record.cameralibrary.util.LogUtil;
import com.record.cameralibrary.util.ScreenUtils;
import com.record.cameralibrary.view.CameraView;
 ...
 * =====================================
 */
public class JCameraView extends ConstraintLayout implements CameraInterface.CameraOpenOverCallback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    private TextView tv_camera_prompt;
    ...
    private LayoutParams surfaceLayoutParams;
    ...
    private void initView() {
        ...
        int height = layout_width / 3 * 4;
        surfaceLayoutParams = new LayoutParams(layout_width, height);
        mVideoView.setLayoutParams(surfaceLayoutParams);

        mPhoto = (ImageView) view.findViewById(R.id.image_photo);
        mPhoto.setLayoutParams(surfaceLayoutParams);
        ...
        tv_camera_prompt = (TextView) view.findViewById(R.id.tv_camera_prompt);
        mVideoView.getHolder().addCallback(sufaceHolderCallback);
        //切换摄像头
...
//        });
    ...
    SurfaceHolder.Callback sufaceHolderCallback = new SurfaceHolder.Callback() {
        //SurfaceView生命周期
        @Override
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void resetState(int type) {
        ...
        tv_camera_prompt.setVisibility(VISIBLE);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if (tv_camera_prompt != null)
                    tv_camera_prompt.setVisibility(GONE);
            }
        },3000);
        mSwitchCamera.setVisibility(VISIBLE);
        mFlashLamp.setVisibility(GONE);
