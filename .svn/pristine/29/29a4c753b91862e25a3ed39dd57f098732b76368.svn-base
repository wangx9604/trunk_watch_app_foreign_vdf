...
class FocusImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        mFocusImg = typedArray.getResourceId(R.styleable.FocusImageView_focus_focusing, NO_ID)
        mFocusSucceedImg =
            typedArray.getResourceId(R.styleable.FocusImageView_focus_success, NO_ID)
        mFocusFailedImg = typedArray.getResourceId(R.styleable.FocusImageView_focus_fail, NO_ID)
        typedArray.recycle()
