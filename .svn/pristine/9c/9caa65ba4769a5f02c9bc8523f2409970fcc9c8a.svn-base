 ...
 * @author liutianxiang
 */
public class CustomerPickerView1 extends View
{
	...
	private String colorBack = "#20000000";
	private String colorChoose = "#000000";
	...
	public CustomerPickerView1(Context context)
	{
		super(context);
		init();
	}

	public CustomerPickerView1(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void init()
	{
		...
		mPaint.setColor(Color.parseColor(colorBack));
		
		mCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		mCirclePaint.setAntiAlias(true);
		mCirclePaint.setStrokeWidth((float) 3.0);
		mCirclePaint.setStyle(Style.STROKE);
		mCirclePaint.setColor(Color.parseColor(colorBack));
	...
	private void drawData(Canvas canvas)
	{
		...
		mPaint.setColor(Color.parseColor(colorChoose));
