...
import com.record.cameralibrary.util.CheckPermission;
import com.record.cameralibrary.util.LogUtil;

import static com.record.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static com.record.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.record.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private float outside_add_size;       //长按外圆半径变大的Size
    private float inside_reduce_size;     //长安内圆缩小的Size
    ...
    private float button_size;                //按钮大小
    ...
    public CaptureButton(Context context, float size) {
        super(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension((int) (button_size + outside_add_size * 2), (int) (button_size + outside_add_size * 2));
    }
