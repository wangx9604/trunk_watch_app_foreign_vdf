...
import com.xiaoxun.xun.motion.adapters.MotionItemHolder;
...
public class SportRecordAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ((com.xiaoxun.xun.motion.adapters.MotionItemHolder)viewHolder).bindTo(mSportList.get(i),"");
    }
    ...
    private class RecordTitleViewHolder extends RecyclerView.ViewHolder implements com.xiaoxun.xun.motion.adapters.MotionItemHolder {
    ...
    private class RecordStartViewHolder extends RecyclerView.ViewHolder implements com.xiaoxun.xun.motion.adapters.MotionItemHolder {
    ...
    private class RecordCenterViewHolder extends RecyclerView.ViewHolder implements com.xiaoxun.xun.motion.adapters.MotionItemHolder {
